...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shaderLightingPass.setInt("lightAmount", amount);
        ...
        { //================imgui  Code=====================
            ...
            if (ImGui::SliderInt("lighting amount", &amount, 0, 500))
            {
                configLightInfo(amount ,lightPositions ,lightColors);
            }
...
void configLightInfo(int lightAmount ,std::vector<glm::vec3>& lightPositions ,std::vector<glm::vec3>& lightColors)
{
