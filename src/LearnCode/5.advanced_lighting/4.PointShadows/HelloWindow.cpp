...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(2.0f, 0.0f, 0.0f), glm::vec3(0.0f, -2.0f, 0.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(-2.0f, 0.0f, 0.0f), glm::vec3(0.0f, -2.0f, 0.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(0.0f, 2.0f, 0.0f), glm::vec3(0.0f, 0.0f, 2.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(0.0f, -2.0f, 0.0f), glm::vec3(0.0f, 0.0f, -2.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(0.0f, 0.0f, 2.0f), glm::vec3(0.0f, -2.0f, 0.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(0.0f, 0.0f, -2.0f), glm::vec3(0.0f, -2.0f, 0.0f)));
        ...
        ImGui::SliderFloat3("lightPosData", lightPosData,-10.0f, 10.0f);
        ImGui::SliderFloat2("Camera xoffset", cameraOffset,-100.0f, 100.0f);
        ImGui::SliderFloat("float", &roomCubeSzie, 0.0f, 10.0f);    
...
void renderScene(const Shader &shader)
{
    ...
    model = glm::scale(model, glm::vec3(roomCubeSzie));
