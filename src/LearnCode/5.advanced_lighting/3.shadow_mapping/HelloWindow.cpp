...
int main()
{
    ...
    Shader simpleDepthShader((shaderPath + "shadow_mapping_depth.vs").c_str(), (shaderPath + "shadow_mapping_depth.fs").c_str());
    Shader debugDepthQuad((shaderPath + "debug_quad.vs").c_str(), (shaderPath + "debug_quad.fs").c_str());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (ImGui::Button("Change Camera"))
        {
            ...
            // xoffset = 0;
            // yoffset = 0;
            cout<< isFragDepth <<endl;
        }
        ImGui::Checkbox("Is Show FragDepth",&isFragDepth);
        ImGui::End();
        ImGui::Render();
