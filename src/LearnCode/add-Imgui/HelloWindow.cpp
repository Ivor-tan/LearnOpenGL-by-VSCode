...
int main()
{
    ...
    // -------------------------
    Shader shaderRed("./src/shaders/advanced_glsl.vs", "./src/shaders/boxColor.fs");
    Shader shaderGreen("./src/shaders/advanced_glsl.vs", "./src/shaders/boxColor.fs");
    Shader shaderBlue("./src/shaders/advanced_glsl.vs", "./src/shaders/boxColor.fs");
    Shader shaderYellow("./src/shaders/advanced_glsl.vs", "./src/shaders/boxColor.fs");
    ...
    ImVec4 box1 = ImVec4(0.45f, 0.55f, 0.60f, 1.00f);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shaderRed.setVec4("boxColor",glm::vec4(box1.x,box1.y,box1.z,box1.w));
        ...
        shaderGreen.setVec4("boxColor",glm::vec4(box2.x,box2.y,box2.z,box2.w));
        glDrawArrays(GL_TRIANGLES, 0, 36);
        // YELLOW
        shaderYellow.use();
        model = glm::mat4(1.0f);
        ...
        shaderYellow.setVec4("boxColor",glm::vec4(box3.x,box3.y,box3.z,box3.w));
        glDrawArrays(GL_TRIANGLES, 0, 36);
        // BLUE
        shaderBlue.use();
        model = glm::mat4(1.0f);
        ...
        shaderBlue.setVec4("boxColor",glm::vec4(box4.x,box4.y,box4.z,box4.w));
        glDrawArrays(GL_TRIANGLES, 0, 36);
