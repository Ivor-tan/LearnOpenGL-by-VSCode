...
//     ---- 位置 ----       ---- 颜色 ----     - 纹理坐标 -
    ...
    // // GL_CLAMP_TO_BORDER	超出的坐标为用户指定的边缘颜色。y
    // glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
    // glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);

    // // GL_NEAREST产生了颗粒状的图案，我们能够清晰看到组成纹理的像素，而
...
#pragma endregion 绑定一个纹理

    #pragma region  绑定两个纹理
